...
function resolveTheme(setting: ThemeSetting): EffectiveTheme {
  if (setting === "system") {
...
function MenuItem({ active, onClick, icon, label }: { active: boolean; onClick: () => void; icon: React.ReactNode; label: string }) {
  return (
    <button
      role="menuitemradio"
      aria-checked={active}
